	...
	return (
		<>
			...
			<SectorsList title="Политика по уменьшению загрязнений"
					...
					items={sectors}
					/>
			<Footer logosFooter={partners}
					linksFooter={navLinks}
					discr1="2020, Все права защищены" 
					discr2="Согласие на обработку персональных данных Политика конфиденциальности"
					discr3=""
					/>
		</>
	);
